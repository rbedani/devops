...
class Job:
    ...
    def from_row(cls, row: sqlite3.Row) -> Job:
        ...
        tags_raw = row["tags"] if "tags" in row.keys() else "[]"  # noqa: SIM401, SIM118 — sqlite3.Row lacks __contains__ on Python 3.11
        ...
        return cls(
            ...
            status=row["status"] if "status" in row.keys() else "",  # noqa: SIM401, SIM118 — sqlite3.Row lacks __contains__ on Python 3.11
        )
